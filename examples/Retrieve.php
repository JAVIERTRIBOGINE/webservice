...
define('PS_SHOP_PATH', 'https://api.themoviedb.org');							// Root path of your PrestaShop store
define('PS_WS_AUTH_KEY', '057160268b04bd141cff9180df139330');	// Auth key (Get it in your Back Office)
